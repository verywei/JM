...
public class Upload extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		// 创建文件夹
		String path=getServletContext().getRealPath("/"+folder+"/");
				...
				if(items!=null) {
					for (FileItem item : items) {//遍历
						if (item.isFormField()) {
							...
							String path = String.format("G:\\myeclipse\\apache-tomcat-9.0.1\\webapps\\UploadJWPro1\\upload\\%s%s", getRandomFileName(),suffix);							
