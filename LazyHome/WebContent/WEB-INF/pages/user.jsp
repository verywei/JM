          ...
          <section class="wrapper">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td class="col-md-10">女</td>
                </tr>
                <tr>
                    <td class="col-md-2">年龄</td>
                    <td class="col-md-10">17</td>
                </tr>
                <tr>
                    <td class="col-md-2">邮箱</td>
                    <td class="col-md-10">22@firedox.com</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="col-md-2">已完成的订单</td>
                    <td class="col-md-10"><a href="order.html">点击查看</a></td>
                </tr>
            </table>
              <!-- page end-->
          </section>
