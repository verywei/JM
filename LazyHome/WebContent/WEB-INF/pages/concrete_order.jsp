      ...
      <section id="main-content">
          <section class="wrapper">
            <table class="table table-striped">
                ...
                <tr>
                    <td class="col-md-2">发单人</td>
                    <td class="col-md-10">小明</td>
                </tr>
                 <tr>
                    <td class="col-md-2">接单人</td>
                    <td class="col-md-10">小小</td>
                </tr>
                <tr>
                    <td class="col-md-2">发单地址</td>
                    <td class="col-md-10">武汉科技大学</td>
                </tr>
                <tr>
                    <td class="col-md-2">接单地址</td>
                    <td class="col-md-10">武汉科技大学南八</td>
                </tr>
                <tr>
                    <td class="col-md-2">预计送达时间</td>
                    <td class="col-md-10">2017-11-18 23:00</td>
                </tr>
                <tr>
                    <td class="col-md-2">接单者现在的位置</td>
                    <td class="col-md-10">订单已完成</td>
                </tr>
                <tr>
                    <td class="col-md-2">送达时间</td>
                    <td class="col-md-10">2017-11-18 00:00</td>
                </tr>
                <tr>
                    <td class="col-md-2">订单完成状态</td>
                    <td class="col-md-10">已完成</td>
                </tr>
                <tr>
                    <td class="col-md-2">买家实际付款</td>
                    <td class="col-md-10">80.00元</td>
                </tr>
