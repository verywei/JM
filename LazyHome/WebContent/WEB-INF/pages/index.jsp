...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <div class="top-nav notification-row" style="margin-top: 20px;">
                <span><a href="login.html" style="font-size:16px">登录</a></span>&nbsp;&nbsp;
                <span><a href="register.html" style="font-size:16px">注册</a></span>
            </div>
