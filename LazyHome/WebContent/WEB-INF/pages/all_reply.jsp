...
<html lang="en">
  ...
  <section id="container" class="">
     ...
     <header class="header dark-bg">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-table"></i>评论管理</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
            <li><i class="fa fa-table"></i>评论管理</li>
            <li><i class="fa fa-th-list"></i>所有回复</li>
          </ol>
        </div>
      </div>
              <div class="row">
                           ...
                           <tbody>
                              <tr>
                                <th><i class="icon_profile"></i>id</th>
                                 <th><i class="icon_profile"></i>发回复者</th>
                                 <th><i class="icon_profile"></i>被回复者</th>
                                 <th><i class="icon_calendar"></i>发表时间</th>
                                 <th><i class="icon_mail_alt"></i>订单号></th>
                                 <th><i class="icon_cogs"></i>操作</th>
                                 
                              </tr>
                              <tr>
                                 <td></i><a href="user.html">201513138054</a></td>
                                 <td><a href="user.html">lr</a></td>
                                 <td><a href="user.html">hyj</a></td>
                                 <td>207-11-17 22:11</td>
                                 <td><a href="conrete_order.html">2123123</a></td>   
                                 <td>
                                  <div class="btn-group">
                                     <!--  <a class="btn btn-primary" href="#"><i class="icon_plus_alt2"></i></a> -->
                                      <a class="btn btn-info" href="#">查看</a>
                                      <a class="btn btn-warning" href="#">注销</a>
                                  </div>
                                  </td>
                              </tr>
                              <tr>
